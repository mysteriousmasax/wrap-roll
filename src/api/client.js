...
export const api = {
  ...
  sendPublicChatMessage: (conversationId, message, customerName) => request(`/chat/public/${encodeURIComponent(conversationId)}/messages`, { method: 'POST', body: JSON.stringify({ message, customerName }) }),
