...
export const api = {
  ...
  updateInventoryCategory: (id, data) => request(`/inventory/categories/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteInventoryCategory: (id) => request(`/inventory/categories/${id}`, { method: 'DELETE' }),
  getInventoryStorageLocations: () => request('/inventory/storage-locations'),
  createInventoryStorageLocation: (data) => request('/inventory/storage-locations', { method: 'POST', body: JSON.stringify(data) }),
  updateInventoryStorageLocation: (id, data) => request(`/inventory/storage-locations/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deleteInventoryStorageLocation: (id) => request(`/inventory/storage-locations/${id}`, { method: 'DELETE' }),
